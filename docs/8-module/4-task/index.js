  ...
  renderProduct(product, count) {
    ...
    <div class="cart-product" data-product-id="${
      ...
      <div class="cart-product__img">
        <img src="/docs/assets/images/products/${product.image}" alt="product">
      </div>
        ...
        <div class="cart-product__price-wrap">
          <div class="cart-counter">
            <button type="button" class="cart-counter__button cart-counter__button_minus">
              <img src="/docs/assets/images/icons/square-minus-icon.svg" alt="minus">
            </button>
            <span class="cart-counter__count">${count}</span>
            <button type="button" class="cart-counter__button cart-counter__button_plus">
              <img src="/docs/assets/images/icons/square-plus-icon.svg" alt="plus">
            </button>
          </div>
        ...
        this.popup.setBody(createElement(`
            <div class="modal__body-inner">
              <p>
                ...
                <img src="/docs/assets/images/delivery.gif">
              </p>
            </div>
          `));
    });
